 ...
 <div style="padding:50px;">
   <table class="table table-bordered">
    <thead class="thead-dark" style="background-color: black; color: white;">
      <tr>
        <th scope="col">Missing ID</th>
        <th scope="col">Missing Name</th>
		...
		<th scope="col">Appearence and Dress</th>
...
<?php
    ...
    <tbody style="background-color: white; color: black;">
      <tr>
        ...
        <td><?php echo $rows['mfname']; ?></td>     
        <td><?php echo $rows['mnname']; ?></td> 
        <td><?php echo $rows['mage']; ?></td>
		<td><?php echo $rows['msex']; ?></td>
		<td><?php echo $rows['mheight']; ?></td>
		<td><?php echo $rows['mweight']; ?></td>
		<td><?php echo $rows['mlseen']; ?></td>
		<td><?php echo $rows['mappd']; ?></td>
