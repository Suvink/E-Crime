...
<head>
    ...
    if(isset($_POST['s2']))
    {
     ...
     $result=mysqli_query($conn,"SELECT * FROM missing ");
    ?>
 <script>
     function f1()
        {
 ...
 <div style="padding:50px;">
   <table class="table table-bordered">
    <thead class="thead-dark" style="background-color: black; color: white;">
      <tr>
        <th scope="col">Mortem ID</th>
        <th scope="col">Miortem Full Name</th>
        <th scope="col">Sex</th>
        <th scope="col">FIR No</th>
		<th scope="col">Mortem Result</th>
...
<?php
    ...
    <tbody style="background-color: white; color: black;">
      <tr>
        <td><?php echo $rows['mmid']; ?></td>
        <td><?php echo $rows['pfname']; ?></td>     
        <td><?php echo $rows['psex']; ?></td> 
        <td><?php echo $rows['pfirno']; ?></td>
		<td><?php echo $rows['presult']; ?></td>
		<td><?php echo $rows['pdatedeath']; ?></td>
		<td><?php echo $rows['pdescase']; ?></td>
		<td><?php echo $rows['pplace']; ?></td>
