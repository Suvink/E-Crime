...
<head>
    ...
    if(isset($_POST['s2']))
    {
     ...
     $result=mysqli_query($conn,"SELECT * FROM crimereg ");
    ?>
 <script>
     function f1()
        {
   ...
   <table class="table table-bordered">
    <thead class="thead-dark" style="background-color: black; color: white;">
      <tr>
        ...
        <th scope="col">Criminal Nick name</th>
        <th scope="col">Sex</th>
...
<?php
    ...
    <tbody style="background-color: white; color: black;">
      <tr>
        ...
        <td><?php echo $rows['cnickname']; ?></td> 
        <td><?php echo $rows['csex']; ?></td>
		<td><?php echo $rows['coccupation']; ?></td>
