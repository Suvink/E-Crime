...
<head>
    ...
    if(isset($_POST['s2']))
    {
     ...
     $result=mysqli_query($conn,"SELECT * FROM wanted");
    ?>
 <script>
     function f1()
        {
   ...
   <table class="table table-bordered">
    <thead class="thead-dark" style="background-color: black; color: white;">
      <tr>
        ...
        <th scope="col">Wanted Full name</th>
...
<?php
    ...
    <tbody style="background-color: white; color: black;">
      <tr>
        <td><?php echo $rows['wid']; ?></td>
        <td><?php echo $rows['wfname']; ?></td>     
        <td><?php echo $rows['wnname']; ?></td> 
        <td><?php echo $rows['wage']; ?></td>
		<td><?php echo $rows['wsex']; ?></td>
		<td><?php echo $rows['wplace']; ?></td>
		<td><?php echo $rows['wdes']; ?></td>
